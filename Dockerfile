...
# Build the project
RUN wget https://github.com/altbetproject/Beetok/releases/download/v1.2.0.0/beetok-1.1.0-x86_64-linux-gnu.tar.gz -O beetok-1.1.0.tar.gz
