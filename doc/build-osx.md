...
4. Enter "beetok-qt" as project name, enter src/qt as location
...
Once dependencies are compiled, see release-process.md for how the Beetok-Qt.app
...
you can monitor its process by looking at the debug.log file, like this:
    ...
    tail -f $HOME/Library/Application\ Support/Beetok/debug.log
...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure Beetok with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the Beetok wallet:
...
You have the choice to build the GUI Beetok wallet as a Mac OSX app, described in “How to build the Beetok-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the Beetok-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find Beetok-Qt.dmg inside your Beetok folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/Beetok/src/qt/beetok-qt
