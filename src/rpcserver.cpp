...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Beetok features */
        {"beetok", "masternode", &masternode, true, true, false},
        {"beetok", "listmasternodes", &listmasternodes, true, true, false},
        {"beetok", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"beetok", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"beetok", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"beetok", "getmasternodecount", &getmasternodecount, true, true, false},
        {"beetok", "masternodeconnect", &masternodeconnect, true, true, false},
        {"beetok", "masternodecurrent", &masternodecurrent, true, true, false},
        {"beetok", "masternodedebug", &masternodedebug, true, true, false},
        {"beetok", "startmasternode", &startmasternode, true, true, false},
        {"beetok", "createmasternodekey", &createmasternodekey, true, true, false},
        {"beetok", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"beetok", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"beetok", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"beetok", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"beetok", "getmasternodescores", &getmasternodescores, true, true, false},
        {"beetok", "mnbudget", &mnbudget, true, true, false},
        {"beetok", "preparebudget", &preparebudget, true, true, false},
        {"beetok", "submitbudget", &submitbudget, true, true, false},
        {"beetok", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"beetok", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"beetok", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"beetok", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"beetok", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"beetok", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"beetok", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"beetok", "checkbudgets", &checkbudgets, true, true, false},
        {"beetok", "mnsync", &mnsync, true, true, false},
        {"beetok", "spork", &spork, true, true, false},
        {"beetok", "getpoolinfo", &getpoolinfo, true, true, false},
        {"beetok", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> beetok-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9322/\n";
}
