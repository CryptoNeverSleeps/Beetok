...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total beetok balance of the wallet (excluding zerocoins)\n"
            ...
            "     \"10\" : n,           (numeric) supply of 10 zBTOK denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBTOK denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBTOK denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBTOK denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBTOK denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBTOK denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBTOK denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in beetok/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in beetok/kb\n"
    ...
    obj.push_back(Pair("zABETsupply", zabetObj));
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are beetok addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) beetok address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"altbetaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"altbetaddress\"  (string, required) The beetok address to use for the signature.\n"
