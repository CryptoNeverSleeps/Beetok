 ...
 */
    ...
    typeWidget->addItem(tr("Received Btok from zBtok"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBtok"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAbet));
